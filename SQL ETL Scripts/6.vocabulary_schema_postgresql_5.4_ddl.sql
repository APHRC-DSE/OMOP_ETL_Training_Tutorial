...
CREATE TABLE vocabulary.person (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.observation_period (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.visit_occurrence (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.visit_detail (
			...
			visit_occurrence_id integer NOT NULL );
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.condition_occurrence (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.drug_exposure (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.procedure_occurrence (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.device_exposure (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.measurement (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.observation (
...
CREATE TABLE vocabulary.note_nlp (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.specimen (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.fact_relationship (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.location (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.care_site (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.provider (
			...
			gender_source_concept_id integer NULL );
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.payer_plan_period (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.drug_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.dose_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.condition_era (
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE vocabulary.episode (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.episode_event (
			episode_id integer NOT NULL,
			event_id integer NOT NULL,
			episode_event_field_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.metadata (
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.cdm_source (
...
CREATE TABLE vocabulary.drug_strength (
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE vocabulary.cohort (
