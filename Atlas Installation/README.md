...
- [Install Docker via WSL Terminal](https://docs.docker.com/get-docker/) and configure it for your system
- Deploy [OHDSI Broadsea](https://github.com/OHDSI/Broadsea) for running ATLAS and WebAPI
